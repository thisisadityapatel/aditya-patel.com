export const experiences = [
    {
        ...
        "description" : [
            "I interned at Scotiabank as a Trade Floor Web Developer and Technology Analyst in the Global Banking and Markets Technology Team. In this role I worked on Scotiabank's trade floor, engineering full stack web development (C#) projects and enhancement of web-based systems.",
            "As part of the Global Banking & Markets Technology team, I analyzed business processes, liaise with various groups within the bank, engineered web-based systems, and design user interfaces to meet business needs. I had the chance to work with advanced web development technologies, including working with large datasets, bulk editing, APIs, encryption, and intelligent prediction using analytics/machine learning.",
